...
# DIRECTORY to
ADD . /usr/local/docker-ci-sample
...
RUN cd /usr/local/docker-ci-sample && mvn package 
...
CMD ["java", "-cp", "/usr/local/docker-ci-sample/target/java-project-1.0-SNAPSHOT.jar", "com.mkyong.hashing.App"]
